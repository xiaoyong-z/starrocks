    ...
    if (is_scalar_field_type(delegate_type(_column_type))) {
        ...
        for (int i = 0; i < meta->indexes_size(); i++) {
            ...
            case ZONE_MAP_INDEX:
                ...
                indexTracker->consume(_zone_map_index.meta->SpaceUsedLong());
                break;
            case BITMAP_INDEX:
                ...
                indexTracker->consume(_bitmap_index.meta->SpaceUsedLong());
                break;
            case BLOOM_FILTER_INDEX:
                ...
                indexTracker->consume(_bloom_filter_index.meta->SpaceUsedLong());
                break;
...
Status ColumnReader::_load_ordinal_index(bool use_page_cache, bool kept_in_memory) {
    ...
    if (_flags[kHasOrdinalIndexMetaPos]) {
        ...
        ExecEnv::GetInstance()->column_reader_index_mem_tracker()->release(index_meta->SpaceUsedLong());
        ...
        ExecEnv::GetInstance()->column_reader_index_mem_tracker()->consume(_ordinal_index.reader->mem_usage());
    }
    return st;
}
...
Status ColumnReader::_load_zone_map_index(bool use_page_cache, bool kept_in_memory) {
    ...
    if (_flags[kHasZoneMapIndexMetaPos]) {
        ...
        ExecEnv::GetInstance()->column_reader_index_mem_tracker()->consume(_zone_map_index.reader->mem_usage());
    }
    return st;
}
...
Status ColumnReader::_load_bitmap_index(bool use_page_cache, bool kept_in_memory) {
    ...
    if (_flags[kHasBitmapIndexMetaPos]) {
        ...
        ExecEnv::GetInstance()->column_reader_index_mem_tracker()->consume(_bitmap_index.reader->mem_usage());
    }
    return st;
}
...
Status ColumnReader::_load_bloom_filter_index(bool use_page_cache, bool kept_in_memory) {
    ...
    if (_flags[kHasBloomFilterIndexMetaPos]) {
        ...
        ExecEnv::GetInstance()->column_reader_index_mem_tracker()->consume(_bloom_filter_index.reader->mem_usage());
    }
    return st;
}
