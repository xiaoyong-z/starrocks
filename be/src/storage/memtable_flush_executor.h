...
public:
    ...
    Status submit(std::unique_ptr<vectorized::MemTable> memtable);
...
private:
    ...
    void _flush_memtable_context(vectorized::MemTableFlushContext* memtable);

    void _flush_memtable(vectorized::MemTable* memtable);
